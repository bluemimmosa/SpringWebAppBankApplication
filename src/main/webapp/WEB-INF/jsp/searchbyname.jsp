...
<!--                            <img src="${pageContext.request.contextPath}/resources/images/logo.png" id="icon" alt="User Icon" />-->
                        ...
                        <form:form method="POST" modelAttribute="account" action="processsearchaccountbyname">
                        <form:input id="login" class="fadeIn second" placeholder="ACCOUNT NAME" path="name"/>
                        <form:button id="submit" class="fadeIn fourth" name="submit">Search</form:button>
                        </form:form>
                        <div id="formFooter">
                            ${message}
                        </div>
