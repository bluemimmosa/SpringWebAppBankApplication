...
<!--                    <li><a href="#"><i class="fa fa-fw fa-user"></i> Edit Profile</a></li>
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                ...
                <li>
                    <a href="faq"><i class="fa fa-fw fa fa-question-circle"></i> Withdraw</a>
                </li>
                <li>
...
<!--                            <img src="${pageContext.request.contextPath}/resources/images/logo.png" id="icon" alt="User Icon" />-->
                        ...
                        <form:form id="regForm" modelAttribute="account" action="processNewAccount" method="POST">
                            ...
                            <form:input path="name" class="fadeIn second" placeholder="ACCOUNT NAME" name="name"/>
                            <form:input path="mobileNo" class="fadeIn second" placeholder="MOBILE NO" name="mobileNo"/>
                            <form:input path="balance" class="fadeIn second" placeholder="OPENING BALANCE" name="balance"/>
                            <form:input path="accountType" class="fadeIn second" placeholder="ACCOUNT TYPE" name="accountType"/>
